    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse text-white" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item text-white">
                    <c:url value="/veicolo/veicoli" var="veicolo"/>
                    <a class="nav-link" href="${veicolo}"> <spring:message code="homepage.parcoauto.label"/> </a>
                </li>

                <li class="nav-item">
                    <c:url value="/utente/profilo" var="profilo"/>
                    <a class="nav-link" href="${profilo}"> <spring:message code="homepage.profiloutente.label"/> </a>
                </li>

                <sec:authorize access="hasRole('SUPERUSER')">
                    <li class="nav-item">
                        <c:url value="/prenotazioni/listaPrenotazioni?id=" var="listaPrenotazioni"/>
                        <a class="nav-link" href="${listaPrenotazioni}"> <spring:message
                ...
                <sec:authorize access="isAuthenticated()">
                    ...
                    <li class="nav-item">
                        <a href="${logout}" class="nav-link px-2 text-white">Logout</a></li>
                </sec:authorize>
